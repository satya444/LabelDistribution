...
public class ConnectionManager {
	 ...
	 */
	public static boolean connectHigherNodes(SctpServerChannel serverChannel,int nodeID,int totalNodes,HashMap<Integer, SctpChannel> connectionSocket){
	 ...
	 * to all the processes with a lower PID
	 */
	public static boolean connectLowerNodes(int nodeID,HashMap<Integer, SctpChannel> connectionSocket,HashMap<Integer, NodeDetails> mapNodes){
	 ...
	 * @return
	 */
	public static boolean createConnections(NodeDetails currentNode,HashMap<Integer, SctpChannel> connectionSocket,HashMap<Integer, NodeDetails> mapNodes) {
